...
// MARK: - TDContentStatus

/// The list's current interaction mode, derived by `TDListReducer` and consumed by the shared view
/// to pick which rows to render.
public enum TDContentStatus {
    case plain, editing, adding
}

// MARK: - TDListSwipeAction
