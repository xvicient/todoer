...
extension Image {
    ...
    public static let todoer = Image("Todoer", bundle: .module)
    public static let slogan = Image("Slogan", bundle: .module)
    public static let googleLogo = Image("GoogleLogo", bundle: .module)
