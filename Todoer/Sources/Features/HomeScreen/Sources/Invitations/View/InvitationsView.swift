...
/// A view that displays a list of pending invitations for shared todo lists
struct InvitationsView: View {
    /// Store that manages the state and actions for invitations
    @ObservedObject private var store: Store<Invitations.Reducer>

    /// Creates a new InvitationsView
    /// - Parameter store: Store that manages invitations state and actions
